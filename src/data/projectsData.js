...
export const projectsData = [
  ...
  // ===== CONSUMER APPS =====
  {
    id: 39,
    title: "Synapse",
    subtitle: "Over 2,800x Cheaper Data Storage on Monad",
    description:
      "Synapse makes it easy to read and write data on Monad. It works by compressing your data into cryptographic commitments that leverage Monad's parallel execution architecture. A network of validators then process verification tasks concurrently to secure your data across the network. Over 2,800x cheaper data storage on Monad blockchain.",
    image: synapseImg,
    hasCustomImage: true,
    category: "Infrastructure",
    status: "Launched",
    progress: 100,
    tech: ["Monad", "Cryptographic Commitments", "Validator Network"],
  },
  {
    id: 40,
    title: "Cheeseart",
